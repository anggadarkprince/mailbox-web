...
class C_produk extends Controller {
	...
	function get_permission_produk(){
		$id = (integer) (isset($_POST['id']) ? $_POST['id'] : $_GET['id']);
		$result=$this->m_produk->get_permission_produk($id);
		echo $result;
	}
	
	function get_permission_produk_lain_lain(){
		$id = (integer) (isset($_POST['id']) ? $_POST['id'] : $_GET['id']);
		$result=$this->m_produk->get_permission_produk_lain_lain($id);
		echo $result;
	}
	...
	function produk_update(){
		...
		$produk_preward=trim(@$_POST["produk_preward"]);
		$produk_stok_min=trim(@$_POST["produk_stok_min"]);		
		$produk_kredit=trim(@$_POST["produk_kredit"]);
		$produk_kreditrp=trim(@$_POST["produk_kreditrp"]);
		...
		$produk_harga_sor=trim(@$_POST["produk_harga_sor"]);
		$produk_harga_plm=trim(@$_POST["produk_harga_plm"]);
		...
		$produk_harga_kg=trim(@$_POST["produk_harga_kg"]);
		...
		$produk_aktif_mnd=str_replace("'", '"',$produk_aktif_mnd);
		$produk_aktif_sor=trim(@$_POST["produk_aktif_sor"]);
		$produk_aktif_sor=str_replace("/(<\/?)(p)([^>]*>)", "",$produk_aktif_sor);
		$produk_aktif_sor=str_replace(",", ",",$produk_aktif_sor);
		$produk_aktif_sor=str_replace("'", '"',$produk_aktif_sor);
		$produk_aktif_plm=trim(@$_POST["produk_aktif_plm"]);
		$produk_aktif_plm=str_replace("/(<\/?)(p)([^>]*>)", "",$produk_aktif_plm);
		$produk_aktif_plm=str_replace(",", ",",$produk_aktif_plm);
		$produk_aktif_plm=str_replace("'", '"',$produk_aktif_plm);
		...
		$produk_aktif_smg=str_replace("'", '"',$produk_aktif_smg);
		$produk_aktif_kg=trim(@$_POST["produk_aktif_kg"]);
		$produk_aktif_kg=str_replace("/(<\/?)(p)([^>]*>)", "",$produk_aktif_kg);
		$produk_aktif_kg=str_replace(",", ",",$produk_aktif_kg);
		$produk_aktif_kg=str_replace("'", '"',$produk_aktif_kg);
		...
		$produk_awal_jumlah2=trim(@$_POST["produk_awal_jumlah2"]);
		$produk_awal_nilai2=trim(@$_POST["produk_awal_nilai2"]);
		$produk_awal_jumlah3=trim(@$_POST["produk_awal_jumlah3"]);
		$produk_awal_nilai3=trim(@$_POST["produk_awal_nilai3"]);
		$produk_awal_jumlah4=trim(@$_POST["produk_awal_jumlah4"]);
		$produk_awal_nilai4=trim(@$_POST["produk_awal_nilai4"]);
		$produk_tgl_awal_nilai=trim(@$_POST["produk_tgl_awal_nilai"]);$produk_tgl_awal_nilai=trim(@$_POST["produk_tgl_awal_nilai"]);
		...
		$result = $this->m_produk->produk_update($produk_id, $produk_kode, $produk_kodelama, $produk_group, $produk_kategori , $produk_racikan, $produk_edit_harga, $produk_kontribusi, $produk_jenis, $produk_nama, $produk_satuan ,
							...
							$produk_dpromo, $produk_point , $produk_preward, $produk_kredit, $produk_kreditrp,$produk_volume, $produk_harga, $produk_keterangan, $produk_aktif, $produk_aktif_th, $produk_aktif_ki, $produk_aktif_hr, $produk_aktif_tp, $produk_aktif_dps, $produk_aktif_jkt, $produk_aktif_mta, $produk_aktif_blpn, $produk_aktif_kuta, $produk_aktif_btm, $produk_aktif_mks, $produk_aktif_mdn, $produk_aktif_lbk, $produk_aktif_mnd, $produk_aktif_sor, $produk_aktif_plm, $produk_aktif_ygk,$produk_aktif_corp,$produk_aktif_mlg,$produk_aktif_smg, $produk_aktif_kg, $produk_awal_jumlah, $produk_awal_nilai, $produk_awal_jumlah2, $produk_awal_nilai2, $produk_awal_jumlah3, $produk_awal_nilai3, $produk_awal_jumlah4, $produk_awal_nilai4, $produk_tgl_awal_nilai,$produk_harga_ki,$produk_harga_mdn,$produk_harga_mnd,$produk_harga_sor,$produk_harga_plm,$produk_harga_ygk,$produk_harga_mta, $produk_harga_lbk, $produk_harga_hr, $produk_harga_tp, $produk_harga_dps, $produk_harga_blpn, $produk_harga_kuta, $produk_harga_corp, $produk_harga_btm, $produk_harga_jkt,$produk_harga_smg, $produk_harga_mks, $produk_harga_mlg,$produk_harga_kg, $produk_bpom, $produk_stok_min);
		echo $result;
	}
	...
	function produk_search(){
		...
		$produk_bpom=str_replace("/(<\/?)(p)([^>]*>)", "",$produk_bpom);
		$produk_bpom=str_replace("'", '"',$produk_bpom);
		$rawat_produk=trim(@$_POST["rawat_produk"]);
                $produk_search_cabang=trim(@$_POST["produk_search_cabang"]);
		...
		$result = $this->m_produk->produk_search($produk_id, $produk_kode, $produk_kodelama, $produk_group, $produk_kategori, $produk_jenis, $produk_nama, $produk_satuan ,
                                                         ...
                                                         $produk_point, $produk_kredit, $produk_kreditrp, $produk_kontribusi, $produk_volume, $produk_harga, $produk_keterangan, $produk_aktif, $produk_bpom, $produk_search_cabang,
                                                         $start,$end, $kategori2_nama, $rawat_produk);
		echo $result;
	}
	...
	function produk_print(){
		...
		$result = $this->m_produk->produk_print($produk_id, $produk_kode, $produk_kodelama, $produk_group, $produk_kategori, $produk_jenis, $produk_nama, $produk_satuan ,
                                                        $produk_du, $produk_dm , $produk_dultah, $produk_dcard, $produk_dkolega, $produk_dkeluarga, $produk_downer, $produk_dgrooming,
                                                        $produk_point, $produk_kredit,$produk_kreditrp,$produk_volume, $produk_harga, $produk_keterangan, $produk_aktif, $produk_bpom,$produk_search_cabang,$option,$filter);
		...
		fwrite($file, "<body onload='window.print()'><table summary='Produk List'><caption>DAFTAR PRODUK</caption><thead><tr><th scope='col'>No</th><th scope='col'>Kode</th><th scope='col'>Nama</th><th scope='col'>Satuan</th><th scope='col'>Volume</th><th scope='col'>Group</th><th scope='col'>Group2</th><th scope='col'>Jenis</th><th scope='col'>Harga</th><th scope='col'>Point</th><th scope='col'>Kredit (%)</th><th scope='col'>Kredit (Rp)</th><th scope='col'>Produk Aktif</th><th scope='col'>DU</th><th scope='col'>DM</th><th scope='col'>Ultah</th><th scope='col'>Card</th><th scope='col'>Kolega</th><th scope='col'>Klrg</th><th scope='col'>Owner</th><th scope='col'>Groom</th><th scope='col'>Wrtwn</th><th scope='col'>Staff Dr</th><th scope='col'>Staff Non Dr</th><th scope='col'>Promo</th><th scope='col'>Keterangan</th></tr></thead><tfoot><tr><th scope='row'>Total</th><td colspan='$totcolumn'>");
		fwrite($file, $nbrows);
		...
		if($nbrows>0){
			foreach($result->result_array() as $data){
				...
				fwrite($file, number_format($data['produk_kreditrp'],0,",",","));
				fwrite($file,"</td><td>");								
	...
	function produk_sinkronisasi(){
	    $produk_sinkronisasi_opsi=trim(@$_POST["produk_sinkronisasi_opsi"]);
	    $produk_sinkronisasi_cabang=trim(@$_POST["produk_sinkronisasi_cabang"]);
	    
	    $result = $this->m_produk->produk_sinkronisasi($produk_sinkronisasi_opsi, $produk_sinkronisasi_cabang);
	    echo $result;
	}
