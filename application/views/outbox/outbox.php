            ...
            <div class="panel-content">
                <table class="table table-hover table-dynamic">
                    ...
                    <tr>
                        ...
                        <td><a href="<?=site_url()?>outbox/show">Detail</a></td>
                        <td>
                            <a href="<?=site_url()?>outbox/edit" class="btn btn-primary btn-sm m-r-0">EDIT</a>
                            <a href="<?=site_url()?>outbox/delete" class="btn btn-danger btn-sm m-l-0">DELETE</a>
                        </td>
                    </tr>
                    <tr>
                        <td>Trident</td>
