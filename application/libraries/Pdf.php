...
class Pdf extends FPDF
{
     ...
     * @param bool $stretch
     */
    public function set_stretch_table($stretch = false)
    {
     ...
     */
    public function set_table_size($height_cell = 7, $width_cell = 20, $header_height = 7, $has_header = true)
    {
     ...
     */
    public function set_table_style($stroke = 1, $strip = true, $horizontal = true, $vertical = true)
    {
     ...
     */
    public function set_numbering_column($add_numbering = false, $numbering_width = 10)
    {
     ...
     */
    public function set_table_description($add_description = false, $description_position = "top", $description = "Table Data Generated", $sub = "Sub Description", $align = "C")
    {
     ...
     */
    public function set_table_color($r = 0, $g = 0, $b = 0)
    {
     ...
     */
    public function set_table_header_color($r = 0, $g = 0, $b = 0)
    {
     ...
     * @param int $b blue color for odd row
     */
    public function set_table_odd_color($r = 0, $g = 0, $b = 0)
    {
        $this->odd_r_color = $r;
        $this->odd_g_color = $g;
        $this->odd_b_color = $b;
     ...
     */
    public function set_table_even_color($r = 255, $g = 255, $b = 255)
    {
        $this->even_r_color = $r;
        $this->even_g_color = $g;
        $this->even_b_color = $b;
     ...
     */
    public function set_table_font_color($r = 0, $g = 0, $b = 0)
    {
        $this->font_r_color = $r;
        $this->font_g_color = $g;
        $this->font_b_color = $b;
     ...
     */
    public function set_table_font_header_color($r = 0, $g = 0, $b = 0)
    {
     ...
     */
    public function set_table_font_even_color($r = 0, $g = 0, $b = 0)
    {
     ...
     */
    public function set_table_font_odd_color($r = 0, $g = 0, $b = 0)
    {
     ...
     */
    public function set_table_border_color($r = 0, $g = 0, $b = 0)
    {
     ...
     * @param string $author
     */
    public function init($orientation = "L", $size = "A4", $left_margin = 20, $top_margin = 20, $title = "PDF Report", $author = "Angga Ari Wijaya")
    {
        $this->SetTitle($title);
     ...
     */
    public function create_table($header = array(), $data = array(), $width = array(), $header_align = array(), $data_align = array())
    {
        if (sizeof($data) == 0) {
            $empty = true;
        } else {
